        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Theatres_Provinces_ProvinceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConcessionDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConcessionDetails_Concessions_ConcessionId",
                        column: x => x.ConcessionId,
                        principalTable: "Concessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConcessionDetails_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketDetails_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConcessionDetails_ConcessionId",
                table: "ConcessionDetails",
                column: "ConcessionId");

            migrationBuilder.CreateIndex(
                name: "IX_ConcessionDetails_OrderId",
                table: "ConcessionDetails",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Theatres_ProvinceId",
                table: "Theatres",
                column: "ProvinceId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketDetails_OrderId",
                table: "TicketDetails",
                column: "OrderId");
